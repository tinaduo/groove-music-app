...
const Lottie1 = dynamic(() => import('react-lottie'), { ssr: false });

const default1Options = {
    autoplay: true,
...
const default2Options = {
    autoplay: true,
    animationData: require('/public/characters/angry.json'),
};

const Lottie3 = dynamic(() => import('react-lottie'), { ssr: false });

const default3Options = {
    autoplay: true,
            ...
            <main className={styles.main}>
                <div className={styles.parentContainer}>
                    ...
                    <div  className={styles.descriptionContainer}>
                        <div className={styles.tinaContainer}>
                            <div className={styles.character}><Lottie1 options={default1Options} height={92} width={92} /></div>
                            <div className={styles.textContainer}>
                                <h4 className={styles.nameHeader}>Tina D.</h4>
                                <p className={styles.paragraph}>“grande iced matcha latte. thanks :D“ <br></br><br></br> *removes hair in the drink*</p>
                            </div>
                        </div>
                        <div className={styles.keonaContainer}>
                            <div className={styles.character}><Lottie2 options={default2Options} height={92} width={92} /></div>
                            <div className={styles.textContainer}>
                                <h4 className={styles.nameHeader}>Keona A.</h4>
                                <p className={styles.paragraph}>“Hi! Can I grab an Iced Vanilla Blonde Latte Grande please ;). Oh, can I grab that with oat milk! thanks“</p>
                            </div>
                        </div>
                        <div className={styles.chelseaContainer}>
                            <div className={styles.character}><Lottie3 options={default3Options} height={92} width={92} /></div>
                            <div className={styles.textContainer}>
                                <h4 className={styles.nameHeader}>Chelsea W.</h4>
                                <p className={styles.paragraph}>“Heyy hehehe! Can i grab uhhhh an iced oat vanilla latte please venti :D. You're the best, thanks i love you so much (says to a stranger)“</p>
                            </div>
                        </div>
                    </div>
                    <div className={styles.photosContainer}>
                        <img src="/images/image1.jpg" className={styles.placeholder1}></img>
                        <img src="/images/image2.png" className={styles.placeholder2}></img>
                        <img src="/images/image3.png" className={styles.placeholder3}></img>
                        <img src="/images/image4.png" className={styles.placeholder4}></img>
                    </div>
                </div>
            </main>
        </>
