...
export default function ReviewPage() {
    ...
    useEffect(() => {
        ...
        if (name && artists && albumImage) {
            setSongData({ name, artists: artists.split(','), albumImage });
        }
    }, [router.query]);
    ...
    useEffect(() => {
        ...
        image.onload = () => {
            ...
            // if cannot find colour 
            const fallbackColor = "#0E0F11";
 ...
 const fetchAlbumDetails = async () => {
    ...
    return (
        <>
            <Head>
                <title>GROOVE - NEW REVIEW</title>
                <meta name="description" content="Creating New Review" />
                    ...
                    <div className={styles.colourBackground} style={{ background: gradientColor }}>
                        <div className={styles.albumdataContainer}>
                            ...
                            <div className={styles.dataContainer}>
                                <img className={styles.albumImage} src={songData.albumImage} alt="Album Cover" />
