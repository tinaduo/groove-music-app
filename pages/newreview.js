...
export default function NewReview() {
    ...
    useEffect(() => {
        const searchSongs = async () => {
            if (searchKey.trim() === "" || token === "") { // checks if token is empty
                setSongs([]);
                return;
            }
            try {
